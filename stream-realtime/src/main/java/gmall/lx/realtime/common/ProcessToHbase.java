 ...
 * : 2024/12/23 09:02
 */
public class ProcessToHbase extends BroadcastProcessFunction<JSONObject, JSONObject, JSONObject>{
    ...
    public ProcessToHbase(MapStateDescriptor<String, JSONObject> mapStageDesc) {
