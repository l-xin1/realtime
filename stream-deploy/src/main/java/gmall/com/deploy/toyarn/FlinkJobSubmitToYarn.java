...
/**
 * @className: FlinkJobSubmitToYarn
 * @Description: TODO
 * @author: lx
 * @date: 2024/12/26 18:55
 */
public class FlinkJobSubmitToYarn {
    private static final Logger LOG = LoggerFactory.getLogger(FlinkJobSubmitToYarn.class.getName());
