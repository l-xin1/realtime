package com.lx.gmall.realtime.dws.function;
...
/**
 * @className: MapDimFunction
 * @Description: TODO
 * @author: lx
 * @date: 2024/12/15 11:23
 */
public abstract class MapDimFunction<T> extends RichMapFunction<T, T> implements DimFunction<T> {
    ...
    public abstract String getRowKey(TradeSkuOrderBean bean);

    public abstract void addDims(TradeSkuOrderBean bean,
                                 JSONObject dim);
}
