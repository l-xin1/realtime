...
import com.bw.gmall.realtime.common.base.*;
import com.bw.gmall.realtime.common.bean.*;
import com.bw.gmall.realtime.common.constant.*;
 ...
 * @Description: TODO
 * @author: lx
 * @date: 2024/12/15 11:05
 */
public class DwsTradeOrderWindow extends BaseApp {
    /**
     * 运行应用程序DwdTradeOrderDetail、DwsTradeOrderWindow
     * @param args
     * @throws Exception
     */
